...
public class IncomeTests {
    ...
    public void incomeProperties(){
        ...
        Income income = new Income(Long.valueOf(1), "Sueldo", "Sueldo mensual", 35000.0, now, false, 0, 0, 0);
    ...
    public void setUserId(){
        ...
        Income income = new Income(Long.valueOf(1), "Sueldo", "Sueldo mensual", 35000.0, LocalDateTime.now(), false, 0, 0, 0);
    ...
    public void setAvailableIncome(){
        ...
        Income income = new Income(Long.valueOf(1), "Sueldo", "Sueldo mensual", 0.0, LocalDateTime.now(), false, 0, 0, 0);
